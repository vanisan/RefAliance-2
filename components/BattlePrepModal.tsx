...
interface BattlePrepModalProps {
  ...
  showSiegeUnits?: boolean;
}

export default function BattlePrepModal({ onStart, onCancel, title = "Підготовка до бою", enemies = [], showSiegeUnits = true }: BattlePrepModalProps) {
  ...
  const handleStart = () => {
    onStart(selectedArmy, showSiegeUnits ? selectedSiege : []);
  };
