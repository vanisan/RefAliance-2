      ...
      <div className="w-full h-full max-w-5xl rounded-lg wow-panel flex flex-col relative z-10 p-4 border-amber-900 overflow-hidden">
        <div className="flex justify-between items-center mb-4 border-b border-stone-800 pb-2">
          <h2 className="text-lg font-black text-amber-500 uppercase tracking-widest flex items-center gap-2">
            <Globe className="w-5 h-5" /> Карта Світу (Сусіди)
          </h2>
        ...
        {loading ? (
          <div className="flex-1 flex items-center justify-center">
            <p className="text-amber-500 font-bold animate-pulse uppercase tracking-[0.2em] text-xs">Завантаження гравців...</p>
          </div>
        ) : (
          <div className="flex-1 relative">
             <p className="text-[10px] text-stone-400 mb-6 uppercase tracking-widest font-bold">Натисніть на гравця, щоб переглянути його володіння:</p>
        ...
        <p className="absolute bottom-4 left-4 text-[9px] text-stone-500 font-bold uppercase tracking-widest">Випадкові сусіди з Топ-20</p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-4 border-b border-amber-900/30 pb-2">
               <div>
                 ...
                 <p className="text-[10px] text-stone-400 font-bold mt-1">ІНФОРМАЦІЯ ПРО ПОСЕЛЕННЯ</p>
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[60vh] overflow-y-auto pr-2">
               ...
               <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-1.5 mb-1">
                     ...
                     <span className="text-[10px] font-black text-amber-500 uppercase tracking-widest">Сітка будівель:</span>
                  </div>
               ...
               <div className="flex flex-col gap-4">
                  ...
                  <div>
                     <div className="flex items-center gap-1.5 mb-2">
                       ...
                       <span className="text-[10px] font-black text-stone-400 uppercase tracking-widest">Сила армії:</span>
                     </div>
